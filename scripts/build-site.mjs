...
const publicFiles = [
  'index.html', 'privacy.html', 'support.html', 'styles.css', 'custom-shape.css', 'app.js', 'selection-controls.js', 'mosaic-engine.js', 'shape-engine.js', 'custom-shape-ui.js', 'generation-controller.js',
...
for (const required of ['app.js', 'selection-controls.js', 'mosaic-engine.js', 'shape-engine.js', 'custom-shape-ui.js', 'generation-controller.js', 'styles.css', 'custom-shape.css', 'manifest.webmanifest', 'privacy.html', 'support.html']) {
