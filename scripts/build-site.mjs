...
const publicFiles = [
  'index.html', 'styles.css', 'app.js', 'selection-controls.js', 'mosaic-engine.js', 'shape-engine.js', 'generation-controller.js',
...
for (const required of ['app.js', 'selection-controls.js', 'mosaic-engine.js', 'shape-engine.js', 'generation-controller.js', 'styles.css', 'manifest.webmanifest']) {
