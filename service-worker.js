const CACHE_NAME='photomosaic-v7';
const APP_SHELL=['./','./index.html','./styles.css','./mosaic-engine.js','./generation-controller.js','./app.js','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
