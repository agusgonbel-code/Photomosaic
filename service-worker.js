const CACHE_NAME='photomosaic-v8-shapes';
const APP_SHELL=['./','./index.html','./styles.css','./mosaic-engine.js','./shape-engine.js','./generation-controller.js','./app.js','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
